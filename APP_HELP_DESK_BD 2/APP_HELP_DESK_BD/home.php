            ...
            <div class="row">
              <div class="col-2 d-flex justify-content-center">
                <a href="abrir_chamado.php">
                  <img src="../app_help_desk_bd/imagens/abrir_chamado.png" width="70" height="70">
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="consultar_chamado.php">
                  <img src="../app_help_desk_bd/imagens/consultar01.png" width="70" height="70">
                  <p>Consultar</p>
                </a>
              </div>
              ...
              <?php if ($row->perfil != 'Adm' && $row->perfil != 'Tec') { ?>
                <div class="col-2 d-flex justify-content-center">
                  <a href="editar_chamado.php">
                    <img src="APP_HELP_DESK_BD/imagens/editar01.png" width="70" height="70">
                    <p>&nbspEditar</p>
                  </a>
                </div>
                ...
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="../app_help_desk_bd/imagens/autorizar.png" width="70" height="70">
                  <p>Autorizar</p>
                </a>
              </div>
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="../app_help_desk_bd/imagens/Empresa01.png" width="70" height="70">
                  <p>&nbspUsuários</p>
                </a>
              </div>
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="#" style="filter: grayscale(100%); opacity: 0.5;">
                  <img src="../app_help_desk_bd/imagens/formularios.png" width="70" height="70">
                  <p>Relatórios</p>
                </a>
              </div>
              ...
              <div class="col-2 d-flex justify-content-center">
                <a href="usuarios.php">
                  <img src="../app_help_desk_bd/imagens/Usuarios01.png" width="70" height="70">
                  <p>&nbspUsuários</p>
                </a>
              </div>
