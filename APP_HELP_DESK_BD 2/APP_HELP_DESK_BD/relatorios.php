...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark">
    <a class="navbar-brand" href="home.php">
      <img src="../app_help_desk_bd/imagens/formularios.png" width="30" height="30" class="d-inline-block align-top" alt="">
      App Help Desk
    </a>
    <ul class="navbar-nav">
      <li class="nav-item">
            ...
            <div class="row">
              ...
              <div class="col-4 d-flex justify-content-center">
                <a href="andamento.php" style="color:darkorange">
                  <img src="../app_help_desk_bd/imagens/Processamento01.PNG" width="70" height="70">
                  <p>Andamento(<?php 
              ...
              <div class="col-4 d-flex justify-content-center">
                <a href="finalizado.php" style="color:teal">
                  <img src="../app_help_desk_bd/imagens/Finalizados02.PNG" width="70" height="70">
                  <p>Finalizados(<?php 
